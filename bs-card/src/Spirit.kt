...
open class SummonnableCard(
    ...
    override fun effect(p: SpaceTime): Sequence<SpaceTime> = sequenceOf()
}
...
open class SpiritCard(
    ...
    override fun effect(p: SpaceTime): Sequence<SpaceTime> =
