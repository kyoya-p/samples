        ...
        window.onRemoteSignal = async (data) => {
            switch (data.type) {
                ...
                case "answer":
                    ...
                    if (this.peerConnection) await this.peerConnection.setRemoteDescription(new RTCSessionDescription(data));
                    break;
                case "candidate":
                    if (this.peerConnection) await this.peerConnection.addIceCandidate(new RTCIceCandidate(data.candidate));
                    break;
                default:
