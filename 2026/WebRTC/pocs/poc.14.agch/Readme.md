# WebRTC Text Chat POC (poc.14.agch)

WebRTC `RTCDataChannel` を利用した P2P テキストチャット環境。
`poc.13` をベースに `pocs/poc.14.agch` として構成。
...
### クライアントへのアクセス (noVNC)
- NAT1 Client: http://localhost:8181/vnc.html?autoconnect=true
- NAT2 Client: http://localhost:8182/vnc.html?autoconnect=true
- PXY1 Client: http://localhost:8183/vnc.html?autoconnect=true
- PXY2 Client: http://localhost:8184/vnc.html?autoconnect=true
- NAT1 Client 2: http://localhost:8185/vnc.html?autoconnect=true
- PXY1 Client 2: http://localhost:8186/vnc.html?autoconnect=true
