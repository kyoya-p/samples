...
val testEnvs = listOf(
    testEnvBuilder {
        intake.put("""314159265358979 12""")
        outlet.observe("""314000000000000""")
    }
)
...
fun <T : Comparable<T>> MutableList<T>.insert(v: Iterable<T>) = v.forEach { e -> add(bEdge(e).first, e) }
