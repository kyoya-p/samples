...
function createRoom() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const roomRef = yield db.collection('rooms').add(roomWithOffer);
        ...
        roomRef.onSnapshot((snapshot) => __awaiter(this, void 0, void 0, function* () {
        ...
        function collectIceCandidates(roomRef, peerConnection, localName, remoteName) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                roomRef.collection(remoteName).onSnapshot(function (snapshot) {
...
function joinRoomById(roomId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (roomSnapshot.exists) {
            ...
            yield roomRef.update(roomWithAnswer);
            // Code for collecting ICE candidates above
            peerConnection.addEventListener('track', event => {
                console.log('Got remote track:', event.streams[0]);
                event.streams[0].getTracks().forEach(track => {
...
function hangUp(e) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (roomId) {
            const db = firebase.firestore();
            const roomRef = db.collection('rooms').doc(roomId);
            const calleeCandidates = yield roomRef.collection('calleeCandidates').get();
            calleeCandidates.forEach((candidate) => __awaiter(this, void 0, void 0, function* () {
                yield candidate.delete();
            }));
            const callerCandidates = yield roomRef.collection('callerCandidates').get();
            callerCandidates.forEach((candidate) => __awaiter(this, void 0, void 0, function* () {
                yield candidate.delete();
            }));
            yield roomRef.delete();
        }
