...
class RangeListTest : FunSpec({
    ...
    test("toRangeSet1-1") {
        ...
        listOf<ClosedRange<ULong>>().toFlatList() shouldBe emptyList()
        listOf(r1).toFlatList() shouldBe listOf(1UL)
        listOf(r1, r1).toFlatList() shouldBe listOf(1UL)

        val rs1 = listOf(r1)
        rs1.toFlatList() shouldBe listOf(1UL)
        val rs2 = rs1 + listOf(r1)
        rs2.toFlatList() shouldBe listOf(1UL)
