...
fun App() = MaterialTheme {
    ...
    Column {
        ...
        var tf by remember { mutableStateOf(TextFieldValue("test TextField")) }
        TextField(
            value = t,
            textStyle = defaultTextStyle,
            onValueChange = {
//                t = it
                t = it.alignPipes2(textMeasurer, defaultTextStyle, ' ')
            })
...
// カーソル位置にマーカーを埋め込む
@Composable
fun TextFieldValue.alignWithMarker(style: TextStyle = defaultTextStyle(), paddingLetter: Char = ' '): TextFieldValue {
