...
//            implementation(npm("@firebase/firestore", "4.7.10")) // https://www.npmjs.com/package/@firebase/firestore
            implementation(npm("net-snmp", "3.20.0")) // https://www.npmjs.com/package/net-snmp
        }
