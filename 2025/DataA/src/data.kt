...
fun dataSet1() = mapOf(
    "system.cpuUsage" to listItem().map{it.environmentalInfo.usageInfo.systemUsage.cpuUsage}.toList(),
    "system.cpuLoadAverage" to listItem().map{it.environmentalInfo.usageInfo.systemUsage.cpuLoadAverage}.toList(),
    "system.diskSpaceTotal" to listItem().map{it.environmentalInfo.usageInfo.systemUsage.diskSpaceTotal}.toList(),
    "system.swapSpaceTotal" to listItem().map{it.environmentalInfo.usageInfo.systemUsage.swapSpaceTotal}.toList(),
    "heap.usage" to listItem().map{it.environmentalInfo.usageInfo.heapUsage.usage.toDouble()}.toList(),
    "heap.max" to listItem().map{it.environmentalInfo.usageInfo.heapUsage.max.toDouble()}.toList(),
    "heap.init" to listItem().map{it.environmentalInfo.usageInfo.heapUsage.init.toDouble()}.toList(),
    "heap.commited" to listItem().map{it.environmentalInfo.usageInfo.heapUsage.commited.toDouble()}.toList(),
    "vmProcess.uptime" to listItem().map{it.environmentalInfo.usageInfo.vmProcessUsage.uptime.toDouble()}.toList(),
    "vmProcess.cpuTime" to listItem().map{it.environmentalInfo.usageInfo.vmProcessUsage.cpuTime.toDouble()}.toList(),
    "vmProcess.startTime" to listItem().map{it.environmentalInfo.usageInfo.vmProcessUsage.startTime.toDouble()}.toList(),
    "vmProcess.cpuUsage" to listItem().map{it.environmentalInfo.usageInfo.vmProcessUsage.cpuUsage.toDouble()}.toList(),
)
@Serializable
data class Record(
